package org.octopus.dashboard.web.task;
...
public class TaskController {
	...
	public String create(@Valid Task newTask, RedirectAttributes redirectAttributes) {
		...
		redirectAttributes.addFlashAttribute("message", "create task succesfully");
	...
	public String update(@Valid @ModelAttribute("task") Task task, RedirectAttributes redirectAttributes) {
		...
		redirectAttributes.addFlashAttribute("message", "update task succesfully");
		return "redirect:/task/";
	}
	...
	public String delete(@PathVariable("id") Long id, RedirectAttributes redirectAttributes) {
		...
		redirectAttributes.addFlashAttribute("message", "delete task succesfully");
		return "redirect:/task/";
	}
